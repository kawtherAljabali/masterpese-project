               ...
               <div class="formBx">
                  ...
                  <form method="POST" action="/login">
                     ...
                     <div class="theme-input-box">
                        ...
                        <input class="form-control @error('email') is-invalid @enderror "name="email"   placeholder="Email Address" value="{{old('email')}}" />
                        @error('email')
            ...
            <div class="user signupBx">
               <div class="formBx">
                  <form action="{{route('register')}}" method="post">
                     ...
                     <div class="theme-input-box">
                        <input class="form-control" type="text" name="name" placeholder="User Name" value="{{old('name')}}"/>
                        @error('name')
