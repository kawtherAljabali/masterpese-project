...
<div class="page-wrapper">
    ...
    <aside class="menu-sidebar d-none d-lg-block">
        <div class="logo">
            <a href="#">
              <img src="{{ asset('dashboard_theme/images/icon/logoa.png')}}" alt="Cool Admin" />
            </a>
          </div>
                ...
                <ul class="list-unstyled navbar__list">
                    ...
                    <li>
                        <a href="/dashboard/admin">
                            <i style="color: orange" class="fas fa-tachometer-alt"></i>Manage Admin</a>
                    </li>

                    <li>
                        <a href="/dashboard/manage_user">
                            <i style="color: orange" class="fas fa-users"></i>Manage Users</a>
                    </li>

                    <li>
                        <a href="/dashboard/category">
                            <i style="color: orange"class="fas fa-chart-bar"></i>Manage Category</a>
                    </li>


                    <li>
                        <a href="/dashboard/manage_sub">
                            <i style="color: orange" class="fas fa-images"></i>sub catigory</a>
                    </li>
                    <li>
                        <a href="/dashboard/manage_product">
                            <i style="color: orange" class="fas  fa-th-large"></i>Manage product</a>
                    </li>
                
                    <li>
                        <a href="/dashboard/manage_public">
                            <i style="color: orange" class="fas  fa-home"></i>Manage public</a>
                    </li>

                    <li>
                        <a href="/dashboard/msg">
                            <i style="color: orange" class="fas fa-envelope"></i>Manage Massage</a>
                    </li>

                    <li>
                        <a href="/dashboard/mangeorder">
                            <i style="color: orange" class="fas fa-envelope"></i>Manage Order</a>
                    </li>
                        ...
                        <div class="header-button">
                            ...
                            <div class="account-wrap">
                                <div class="account-item clearfix js-item-menu">
                                    <div class="content">
                                        <a style="color: orange"  class="js-acc-btn"  href="#">welcome  {{session('admin')}}</a>
                                    </div>
