...
<!-- Mirrored from theme.bitrixinfotech.com/pet-shop/demo1/cat-food.html by HTTrack Website Copier/3.x [XR&CO'2014], Sun, 10 Jan 2021 17:32:02 GMT -->
<head>
      <!-- Required meta tags -->
      <meta charset="utf-8">
                  ...
                  <div class="col-xl-6 col-lg-6 col-md-6 col-sm-6 col-12">
                     <div class="header-top-left">
                        <ul class="clearfix">
                           ...
                           <li><a href="#"><i class="far fa-envelope"></i> <span class="__cf_email__" data-cfemail="bac9cfcacad5c8cefac3d5cfc8ded5d7dbd3d494d9d5d7">[email&#160;protected]</span></a></li>
                        </ul>
                     </div>
                  </div>
                  <div class="col-xl-6 col-lg-6 col-md-6 col-sm-6 col-12">
                        ...
                        <div class="sidebar-widget category-sub-menu">
                           ...
                           <div class="sidebar-widget-box">
                              <ul class="sidebar-category">
                                 ...
                                 <li><a href="cat-food.html" class="active">Cat Food <span>(6)</span></a></li>
                                 ...
                                 <div class="row">
                                    <div class="col-xl-4 col-lg-4 col-md-6 col-sm-6 col-12">
                                       <div class="product-box text-center">
                                          <div class="product-images">
                                             ...
                                             <img src="assets/images/category/cat/cat5.jpg" alt="">
                                             </a>
                                          ...
                                          <div class="product-content">
                                             <span>Cat Food</span>
                                             <h3 class="theme-title"><a href="shop-detail.html">Whiskas Kitten</a></h3>
                                    ...
                                    <div class="col-xl-4 col-lg-4 col-md-6 col-sm-6 col-12">
                                       <div class="product-box text-center">
                                          <div class="product-images">
                                             <a href="shop-detail.html">
                                             <img src="assets/images/category/cat/cat6.jpg" alt="">
                                             </a>
                                             <div class="pro-whislist-ico">
                                                <i class="far fa-heart"></i>
                                             </div>
                                          ...
                                          <div class="product-content">
                                             <span>Cat Food</span>
                                             <h3 class="theme-title"><a href="shop-detail.html">Fish Chunks in Gravy</a></h3>
                                             <div class="product-ratting">
                                                <i class="fas fa-star ratting-active"></i><i class="fas fa-star ratting-active"></i><i class="fas fa-star ratting-active"></i><i class="fas fa-star"></i><i class="fas fa-star"></i>
                                             </div>
                                             <div class="product-price">
                                    ...
                                    <div class="col-xl-4 col-lg-4 col-md-6 col-sm-6 col-12">
                                       <div class="product-box text-center">
                                          <div class="product-images">
                                             <a href="shop-detail.html">
                                             <img src="assets/images/category/cat/cat7.jpg" alt="">
                                             </a>
                                             <div class="pro-whislist-ico">
                                                <i class="far fa-heart"></i>
                                             </div>
                                          ...
                                          <div class="product-content">
                                             <span>Cat Food</span>
                                             <h3 class="theme-title"><a href="shop-detail.html">Drools Adult Dry</a></h3>
                                             <div class="product-ratting">
                                                <i class="fas fa-star ratting-active"></i><i class="fas fa-star ratting-active"></i><i class="fas fa-star ratting-active"></i><i class="fas fa-star"></i><i class="fas fa-star"></i>
                                             </div>
                                             <div class="product-price">
                                    ...
                                    <div class="col-xl-4 col-lg-4 col-md-6 col-sm-6 col-12">
                                       <div class="product-box text-center">
                                          <div class="product-images">
                                             <a href="shop-detail.html">
                                             <img src="assets/images/category/cat/cat8.jpg" alt="">
                                             </a>
                                             <div class="pro-whislist-ico">
                                                <i class="far fa-heart"></i>
                                             </div>
                                          ...
                                          <div class="product-content">
                                             <span>Dof Food</span>
                                             <h3 class="theme-title"><a href="shop-detail.html">Whiskas Tuna Gravy</a></h3>
                                             <div class="product-ratting">
                                                <i class="fas fa-star ratting-active"></i><i class="fas fa-star ratting-active"></i><i class="fas fa-star ratting-active"></i><i class="fas fa-star"></i><i class="fas fa-star"></i>
                                             </div>
                                             <div class="product-price">
                                    ...
                                    <div class="col-xl-4 col-lg-4 col-md-6 col-sm-6 col-12">
                                       <div class="product-box text-center">
                                          <div class="product-images">
                                             <a href="shop-detail.html">
                                             <img src="assets/images/category/cat/cat9.jpg" alt="">
                                             </a>
                                             <div class="pro-whislist-ico">
                                                <i class="far fa-heart"></i>
                                             </div>
                                          ...
                                          <div class="product-content">
                                             <span>Cat Food</span>
                                             <h3 class="theme-title"><a href="shop-detail.html">Drools Ocean Fish</a></h3>
                                             <div class="product-ratting">
                                                <i class="fas fa-star ratting-active"></i><i class="fas fa-star ratting-active"></i><i class="fas fa-star ratting-active"></i><i class="fas fa-star"></i><i class="fas fa-star"></i>
                                             </div>
                                             <div class="product-price">
                                    ...
                                    <div class="col-xl-4 col-lg-4 col-md-6 col-sm-6 col-12">
                                       <div class="product-box text-center">
                                          <div class="product-images">
                                             <a href="shop-detail.html">
                                             <img src="assets/images/category/cat/cat10.jpg" alt="">
                                             </a>
                                             <div class="pro-whislist-ico">
                                                <i class="far fa-heart"></i>
                                             </div>
                                          ...
                                          <div class="product-content">
                                             <span>Cat Food</span>
                                             <h3 class="theme-title"><a href="shop-detail.html">Whiskas Chicken Kitten</a></h3>
                                             <div class="product-ratting">
                                                <i class="fas fa-star ratting-active"></i><i class="fas fa-star ratting-active"></i><i class="fas fa-star ratting-active"></i><i class="fas fa-star"></i><i class="fas fa-star"></i>
                                             </div>
                                             <div class="product-price">
...
<!-- Mirrored from theme.bitrixinfotech.com/pet-shop/demo1/cat-food.html by HTTrack Website Copier/3.x [XR&CO'2014], Sun, 10 Jan 2021 17:32:04 GMT -->
</html>