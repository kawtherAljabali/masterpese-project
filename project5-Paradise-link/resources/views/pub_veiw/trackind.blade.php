...
<!-- Mirrored from theme.bitrixinfotech.com/pet-shop/demo1/tracking.html by HTTrack Website Copier/3.x [XR&CO'2014], Sun, 10 Jan 2021 17:32:02 GMT -->
<head>
      <!-- Required meta tags -->
      <meta charset="utf-8">
   ...
   <body>
                  ...
                  <div class="col-xl-6 col-lg-6 col-md-6 col-sm-6 col-12">
                     <div class="header-top-left">
                        <ul class="clearfix">
                           ...
                           <li><a href="#"><i class="far fa-envelope"></i> <span class="__cf_email__" data-cfemail="7d0e080d0d120f093d0412080f1912101c1413531e1210">[email&#160;protected]</span></a></li>
                        </ul>
                     </div>
                  </div>
                  <div class="col-xl-6 col-lg-6 col-md-6 col-sm-6 col-12">
      ...
      <div class="page-main">
         ...
         <!-- Bradcrumb -->
         <!-- Order Tracking -->
         <section class="order-tracking-area page-paddings">
            <div class="container">
               <div class="row">
                  <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                     <div class="order-tracking-box">
                        <div class="order-tracking-header">
                           <div class="order-tracking-img"><img src="assets/images/tracking-order.png" alt=""></div>
                           <div class="order-tracking-content">
                              <h3 class="theme-title">Tracking Details</h3>
                              <p class="theme-description">Order Number</p>
                              <h2># A61452B</h2>
                           </div>
                        </div>
                        <div class="order-tracking-chart clearfix">
                           <div class="order-tracking-chart-box">
                              <h3 class="theme-title">Label Created</h3>
                              <p class="theme-description">8 September, 2020</p>
                           </div>
                           <div class="order-tracking-chart-box active">
                              <h3 class="theme-title">Shipped - 123 Start St. Seattle, WA</h3>
                              <p class="theme-description">10 September, 2020</p>
                           </div>
                           <div class="order-tracking-chart-box">
                              <h3 class="theme-title">Spring Store London Oxford Street, 012 United Kingdom</h3>
                              <p class="theme-description">12 September, 2020</p>
                           </div>
                        </div>
                     </div>
                  </div>
