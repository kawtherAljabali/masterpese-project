...
<!-- Mirrored from theme.bitrixinfotech.com/pet-shop/demo1/bird-food.html by HTTrack Website Copier/3.x [XR&CO'2014], Sun, 10 Jan 2021 17:31:42 GMT -->
<head>
      <!-- Required meta tags -->
      <meta charset="utf-8">
                  ...
                  <div class="col-xl-6 col-lg-6 col-md-6 col-sm-6 col-12">
                     <div class="header-top-left">
                        <ul class="clearfix">
                           ...
                           <li><a href="#"><i class="far fa-envelope"></i> <span class="__cf_email__" data-cfemail="4e3d3b3e3e213c3a0e37213b3c2a21232f2720602d2123">[email&#160;protected]</span></a></li>
                        </ul>
                     </div>
                  </div>
                  <div class="col-xl-6 col-lg-6 col-md-6 col-sm-6 col-12">
                        ...
                        <div class="sidebar-widget category-sub-menu">
                           ...
                           <div class="sidebar-widget-box">
                              <ul class="sidebar-category">
                                 <li><a href="dog-food.html">Dog Food <span>(12)</span></a></li>
                                 <li><a href="cat-food.html">Cat Food <span>(6)</span></a></li>
                                 <li><a href="fish-food.html">Fish Food <span>(9)</span></a></li>
                                 <li><a href="bird-food.html" class="active">Bird Food <span>(9)</span></a></li>
                                 ...
                                 <div class="row">
                                    <div class="col-xl-4 col-lg-4 col-md-6 col-sm-6 col-12">
                                       <div class="product-box text-center">
                                          <div class="product-images">
                                             ...
                                             <img src="assets/images/category/birds/birds5.jpg" alt="">
                                             </a>
                                          ...
                                          <div class="product-content">
                                             <span>Bird Food</span>
                                             <h3 class="theme-title"><a href="shop-detail.html">PetNest Bird Feeder</a></h3>
                                    ...
                                    <div class="col-xl-4 col-lg-4 col-md-6 col-sm-6 col-12">
                                       <div class="product-box text-center">
                                          <div class="product-images">
                                             <a href="shop-detail.html">
                                             <img src="assets/images/category/birds/birds6.jpg" alt="">
                                             </a>
                                             <div class="pro-whislist-ico">
                                                <i class="far fa-heart"></i>
                                             </div>
                                          ...
                                          <div class="product-content">
                                             <span>Bird Food</span>
                                             <h3 class="theme-title"><a href="shop-detail.html">Parrots Wizard</a></h3>
                                             <div class="product-ratting">
                                                <i class="fas fa-star ratting-active"></i><i class="fas fa-star ratting-active"></i><i class="fas fa-star ratting-active"></i><i class="fas fa-star"></i><i class="fas fa-star"></i>
                                             </div>
                                             <div class="product-price">
                                    ...
                                    <div class="col-xl-4 col-lg-4 col-md-6 col-sm-6 col-12">
                                       <div class="product-box text-center">
                                          <div class="product-images">
                                             <a href="shop-detail.html">
                                             <img src="assets/images/category/birds/birds7.jpg" alt="">
                                             </a>
                                             <div class="pro-whislist-ico">
                                                <i class="far fa-heart"></i>
                                             </div>
                                          ...
                                          <div class="product-content">
                                             <span>Bird Food</span>
                                             <h3 class="theme-title"><a href="shop-detail.html">Sri Satymev 340</a></h3>
                                             <div class="product-ratting">
                                                <i class="fas fa-star ratting-active"></i><i class="fas fa-star ratting-active"></i><i class="fas fa-star ratting-active"></i><i class="fas fa-star"></i><i class="fas fa-star"></i>
                                             </div>
                                             <div class="product-price">
                                    ...
                                    <div class="col-xl-4 col-lg-4 col-md-6 col-sm-6 col-12">
                                       <div class="product-box text-center">
                                          <div class="product-images">
                                             <a href="shop-detail.html">
                                             <img src="assets/images/category/birds/birds8.jpg" alt="">
                                             </a>
                                             <div class="pro-whislist-ico">
                                                <i class="far fa-heart"></i>
                                             </div>
                                          ...
                                          <div class="product-content">
                                             <span>Dof Food</span>
                                             <h3 class="theme-title"><a href="shop-detail.html">Vitapol Economic Food</a></h3>
                                             <div class="product-ratting">
                                                <i class="fas fa-star ratting-active"></i><i class="fas fa-star ratting-active"></i><i class="fas fa-star ratting-active"></i><i class="fas fa-star"></i><i class="fas fa-star"></i>
                                             </div>
                                             <div class="product-price">
                                    ...
                                    <div class="col-xl-4 col-lg-4 col-md-6 col-sm-6 col-12">
                                       <div class="product-box text-center">
                                          <div class="product-images">
                                             <a href="shop-detail.html">
                                             <img src="assets/images/category/birds/birds9.jpg" alt="">
                                             </a>
                                             <div class="pro-whislist-ico">
                                                <i class="far fa-heart"></i>
                                             </div>
                                          ...
                                          <div class="product-content">
                                             <span>Bird Food</span>
                                             <h3 class="theme-title"><a href="shop-detail.html">Vadigran Mix Bird</a></h3>
                                             <div class="product-ratting">
                                                <i class="fas fa-star ratting-active"></i><i class="fas fa-star ratting-active"></i><i class="fas fa-star ratting-active"></i><i class="fas fa-star"></i><i class="fas fa-star"></i>
                                             </div>
                                             <div class="product-price">
                                    ...
                                    <div class="col-xl-4 col-lg-4 col-md-6 col-sm-6 col-12">
                                       <div class="product-box text-center">
                                          <div class="product-images">
                                             <a href="shop-detail.html">
                                             <img src="assets/images/category/birds/birds10.jpg" alt="">
                                             </a>
                                             <div class="pro-whislist-ico">
                                                <i class="far fa-heart"></i>
                                             </div>
                                          ...
                                          <div class="product-content">
                                             <span>Bird Food</span>
                                             <h3 class="theme-title"><a href="shop-detail.html">PetNest Food</a></h3>
                                             <div class="product-ratting">
                                                <i class="fas fa-star ratting-active"></i><i class="fas fa-star ratting-active"></i><i class="fas fa-star ratting-active"></i><i class="fas fa-star"></i><i class="fas fa-star"></i>
                                             </div>
                                             <div class="product-price">
                                    ...
                                    <div class="col-xl-4 col-lg-4 col-md-6 col-sm-6 col-12">
                                       <div class="product-box text-center">
                                          <div class="product-images">
                                             <a href="shop-detail.html">
                                             <img src="assets/images/category/birds/birds11.jpg" alt="">
                                             </a>
                                             <div class="pro-whislist-ico">
                                                <i class="far fa-heart"></i>
                                             </div>
                                          ...
                                          <div class="product-content">
                                             <span>Bird Food</span>
                                             <h3 class="theme-title"><a href="shop-detail.html">Vitapol Karma Feed</a></h3>
                                             <div class="product-ratting">
                                                <i class="fas fa-star ratting-active"></i><i class="fas fa-star ratting-active"></i><i class="fas fa-star ratting-active"></i><i class="fas fa-star"></i><i class="fas fa-star"></i>
                                             </div>
                                             <div class="product-price">
                                    ...
                                    <div class="col-xl-4 col-lg-4 col-md-6 col-sm-6 col-12">
                                       <div class="product-box text-center">
                                          <div class="product-images">
                                             <a href="shop-detail.html">
                                             <img src="assets/images/category/birds/birds12.jpg" alt="">
                                             </a>
                                             <div class="pro-whislist-ico">
                                                <i class="far fa-heart"></i>
                                             </div>
                                          ...
                                          <div class="product-content">
                                             <span>Bird Food</span>
                                             <h3 class="theme-title"><a href="shop-detail.html">Zupreem FruitBlend</a></h3>
                                             <div class="product-ratting">
                                                <i class="fas fa-star ratting-active"></i><i class="fas fa-star ratting-active"></i><i class="fas fa-star ratting-active"></i><i class="fas fa-star"></i><i class="fas fa-star"></i>
                                             </div>
                                             <div class="product-price">
                                    ...
                                    <div class="col-xl-4 col-lg-4 col-md-6 col-sm-6 col-12">
                                       <div class="product-box text-center">
                                          <div class="product-images">
                                             <a href="shop-detail.html">
                                             <img src="assets/images/category/birds/birds13.jpg" alt="">
                                             </a>
                                             <div class="pro-whislist-ico">
                                                <i class="far fa-heart"></i>
                                             </div>
                                          ...
                                          <div class="product-content">
                                             <span>Bird Food</span>
                                             <h3 class="theme-title"><a href="shop-detail.html">Vitapol Karma Papuga</a></h3>
                                             <div class="product-ratting">
                                                <i class="fas fa-star ratting-active"></i><i class="fas fa-star ratting-active"></i><i class="fas fa-star ratting-active"></i><i class="fas fa-star"></i><i class="fas fa-star"></i>
                                             </div>
                                             <div class="product-price">
...
<!-- Mirrored from theme.bitrixinfotech.com/pet-shop/demo1/bird-food.html by HTTrack Website Copier/3.x [XR&CO'2014], Sun, 10 Jan 2021 17:31:45 GMT -->
</html>