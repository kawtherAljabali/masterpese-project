...
<!-- Mirrored from theme.bitrixinfotech.com/pet-shop/demo1/wishlist.html by HTTrack Website Copier/3.x [XR&CO'2014], Sun, 10 Jan 2021 17:31:31 GMT -->
<head>
      <!-- Required meta tags -->
      <meta charset="utf-8">
   ...
   <body>
                  ...
                  <div class="col-xl-6 col-lg-6 col-md-6 col-sm-6 col-12">
                     <div class="header-top-left">
                        <ul class="clearfix">
                           ...
                           <li><a href="#"><i class="far fa-envelope"></i> <span class="__cf_email__" data-cfemail="a7d4d2d7d7c8d5d3e7dec8d2d5c3c8cac6cec989c4c8ca">[email&#160;protected]</span></a></li>
                        </ul>
                     </div>
                  </div>
                  <div class="col-xl-6 col-lg-6 col-md-6 col-sm-6 col-12">
                        ...
                        <nav class="navbar navbar-expand-lg navbar-light bg-light">
                           ...
                           <div class="collapse navbar-collapse" id="navbarSupportedContent">
                              <ul class="navbar-nav mr-auto">
                                 ...
                                 <li class="nav-item">
                                    <a class="nav-link theme-dropdown-menu active" href="#">Pages <i class="fas fa-caret-down"></i></a>
                           ...
                           <table>
                              ...
                              <tbody>
                                 <tr>
                                    <td>
                                       <div class="cart-pro-box">
                                          <div class="cart-pro-img"><img src="assets/images/small/cat1.jpg" alt=""></div>
                                    ...
                                    <td class="pro-stock in-stock">In Stock</td>
                                    <td><a href="shop-detail.html" class="theme-btn btn-light">Add To Cart</a></td>
                                    <td><button class="cart-tras-btn" data-toggle="modal" data-target="#remove-product"><i class="fas fa-trash-alt"></i></button></td>
                                 </tr>
                                 <tr>
                                    <td>
                                       <div class="cart-pro-box">
                                          <div class="cart-pro-img"><img src="assets/images/small/cat2.jpg" alt=""></div>
                                          <div class="cart-pro-content">
                                    ...
                                    <td><span class="cart-subtotal">$28.00</span></td>
                                    <td class="pro-stock out-stock">Out Of Stock</td>
                                    <td><button class="theme-btn btn-light disable">Add To Cart</button></td>
                                    <td><button class="cart-tras-btn" data-toggle="modal" data-target="#remove-product"><i class="fas fa-trash-alt"></i></button></td>
                                 </tr>
                                 <tr>
                                    <td>
                                       <div class="cart-pro-box">
                                          <div class="cart-pro-img"><img src="assets/images/small/cat3.jpg" alt=""></div>
                                          <div class="cart-pro-content">
                                 ...
                                 <tr>
                                    <td>
                                       <div class="cart-pro-box">
                                          <div class="cart-pro-img"><img src="assets/images/small/cat4.jpg" alt=""></div>
                                          <div class="cart-pro-content">
                                 ...
                                 <tr>
                                    <td>
                                       <div class="cart-pro-box">
                                          <div class="cart-pro-img"><img src="assets/images/small/fish1.jpg" alt=""></div>
                                          <div class="cart-pro-content">
                                 ...
                                 <tr>
                                    <td>
                                       <div class="cart-pro-box">
                                          <div class="cart-pro-img"><img src="assets/images/small/fish2.jpg" alt=""></div>
                                          <div class="cart-pro-content">
                                 ...
                                 <tr>
                                    <td>
                                       <div class="cart-pro-box">
                                          <div class="cart-pro-img"><img src="assets/images/small/fish3.jpg" alt=""></div>
                                          <div class="cart-pro-content">
                                 ...
                                 <tr>
                                    <td>
                                       <div class="cart-pro-box">
                                          <div class="cart-pro-img"><img src="assets/images/small/fish4.jpg" alt=""></div>
                                          <div class="cart-pro-content">
                                 ...
                                 <tr>
                                    <td>
                                       <div class="cart-pro-box">
                                          <div class="cart-pro-img"><img src="assets/images/small/small-pet1.jpg" alt=""></div>
                                          <div class="cart-pro-content">
                                 ...
                                 <tr>
                                    <td>
                                       <div class="cart-pro-box">
                                          <div class="cart-pro-img"><img src="assets/images/small/small-pet2.jpg" alt=""></div>
                                          <div class="cart-pro-content">
      ...
      <!-- Whishlist Slide -->
      <!-- Remove Product -->
      <div class="modal fade remove-popup" id="remove-product" data-backdrop="static" tabindex="-1" role="dialog" aria-hidden="true">
         <div class="modal-dialog" role="document">
            <div class="modal-content">
               <div class="modal-body">
                  ...
                  <div class="theme-remove-box">
                     <h2>Are you sure want to Remove ?</h2>
                  </div>
               </div>
               <div class="modal-footer">
                  <button type="button" class="theme-btn btn-light" data-dismiss="modal">Close</button>
                  <button type="button" class="theme-btn">Remove</button>
               </div>
            </div>
         </div>
      </div>
